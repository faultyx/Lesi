// NOTE:
// THIS IS A VERY BASIC HELP COMMANDS,
// IT WILL BE DEVELOPED AND ADVANCED LATER ON
...
module.exports = {
  execute(client, msg, args) {
    if (cooldown(msg, "help", 4000, "4 seconds")) {
      if (!args[0]) {
        return msg.author.send(`You can view the full command list here: https://github.com/faultyx/Lesi/blob/master/commandList.md`);
  } else {
    let command = args[0];
   ...
   return msg.reply("There was no command name found with the name.");
   }
    }
   }
  }
